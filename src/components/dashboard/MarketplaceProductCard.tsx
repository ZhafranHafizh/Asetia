...
import { ShoppingCart, Star, Package, Plus, CheckCircle } from "lucide-react"
                ...
                {isSold ? (
                    ...
                    <>
                        ...
                        <Button
                            ...
                            className="w-full bg-white text-black font-black border-2 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all rounded-sm uppercase"
                        >
                            {addedToCart ? (
                                <>
